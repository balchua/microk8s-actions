...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield exec.exec("sudo", ["groupadd microk8s"]);
            ...
            yield exec.exec("sudo", ["usermod", "-a", "-G", "microk8s", "$USER"]);
            yield exec.exec("sudo ", ["chown", "-f", "-R", "$USER", "~/.kube"]);
            yield exec.exec("alias", ["kubectl='microk8s kubectl`"]);
        }
        catch (error) {
